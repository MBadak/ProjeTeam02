...
public class US23_ViceDeanOlusturmaStepDefs {
    ...
    @Then("Kullanici Vice Dean Management tiklar")
    public void kullanici_vice_dean_management_tiklar() {
      ReusableMethods.click(viceDeanManagementHomePage.viceDeanManagement);
      ReusableMethods.bekle(1);
    }
