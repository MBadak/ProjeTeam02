...
public class US15ViceDeanStudentOlusturmakStepDefs extends ReusableMethods {
    ...
    public void kullanici_vice_deanhesabi_ile_sing_in_yapar() {
        us15ViceDeanOgrenci.username.sendKeys(ConfigReader.getProperty("viceDeanUsername"));
        bekle(1);
        Assert.assertTrue(us15ViceDeanOgrenci.username.isDisplayed());
        us15ViceDeanOgrenci.password.sendKeys(ConfigReader.getProperty("viceDeanPassword"));
        bekle(1);
    ...
    public void kullanici_student_management_tiklar() {
        ...
        bekle(1);
        js.executeScript("arguments[0].click()", us15ViceDeanOgrenci.StudentManagement);
        bekle(1);
    }
    ...
    public void kullanici_SurName_Alaninin_Bos_Olmadigini_TestEder() {
        assertFalse(us15ViceDeanOgrenci.surnameRequired.isDisplayed());
        bekle(1);
    ...
    public void Kullanici_Email_alanina_gecerli_bir_email_girer(String Email) {
        us15ViceDeanOgrenci.studentemail.sendKeys(Email);
        bekle(1);
    }
    ...
    public void Kullanici_fathername_kutusuna_gecerli_bir_fathername_girer(String fathername) {
        ...
        //us15ViceDeanOgrenci.studentfathername.sendKeys(faker.name().lastName());
        bekle(1);
    }
    ...
    public void kullanici_mothername_Kutusuna_Gecerli_Bir_Mothername_Girer(String mothername) {
        ...
        //us15ViceDeanOgrenci.studentmothername.sendKeys(faker.name().lastName());
        bekle(1);
    ...
    public void kullanici_SSN_bolunume_3_Ve_5_rakamdan_sonra_cizgi_icermeyen_Ve_9_rakamdan_olusan_numarayi_girir() {
        viceDeanManagementHomePage.ssn.sendKeys("369-874102");
        bekle(2);
    }
    ...
    public void kullanici_Ssn_Kutusunu_Siler() {
        ...
        jsClear(us15ViceDeanOgrenci.SSnkutu);
        bekle(3);
    }
    ...
    public void kullanici_Ssn_Kutusuna_Gecerli_Bir_SSN_Girer() {
        us15ViceDeanOgrenci.SSnkutu.sendKeys("123-97-4152");
        bekle(2);
    }
    ...
    public void kullanici_Phone_Kutusuna_Karekterden_Az_Sayi_Girince_Minimum_Character_Uyarisini_Gorur() {
        ...
        us15ViceDeanOgrenci.studentPhone.sendKeys("963-952-74");
        bekle(2);
